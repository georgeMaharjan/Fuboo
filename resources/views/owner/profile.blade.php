            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="editprofileTitle">Edit Details</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body" >
                        <form action = "{{route('owner.update',Auth::user()->id)}}" enctype="multipart/form-data" method="POST" style="font-size:20px;" >
                            @method('PUT')
                            @csrf
                            ...
                            <div class="d-inline-block">
                                @foreach($owner as $details)
                                    ...
                                    <div class="d-inline-block ml-4">
                                        ...
                                        <button type = "submit" class="btn btn-dark" data-toggle="modal" data-target="#editprofile">Edit</button >
                                    </div>
                                @endforeach
                            </div>
                        </div>
