...
(function($) {
    $.fn.uploader = function(options, testMode) {
        return this.each(function(index) {
            options = $.extend({
                instructionsCopy: 'Upload image only',
            ...
            var dom = {
                ...
                selectButton: $('<input style="height: 0; width: 0;" name="images[]" id="fileinput' + index + '" type="file" multiple class="js-uploader__file-input uploader__file-input">' +
